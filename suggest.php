...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $mail->addAddress('LeePaul@localhost', 'Spencer');     // Add a recipient
        
        $mail->isHTML(false);                                  // Set email format to HTML
        
        $mail->Subject = 'Media Collection Suggestion from ' . $name;
    ...
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            ...
            if (isset($error_message)) {
                ...
                echo "<p>If you come up with any ideal's. Feel free to contact me by email. Complete the form below to send me an email. (Note: Form Submission IS DOWN DUE TO MAINTENANCE!!) THANK YOU </p>";
            }
        ?>
        <form method="post" action="suggest.php">
            ...
            <tr>
                <th><label for="name">Thoughts or Concerns</label></th>
